...
class BarcodeReaderCameraSourcePreview(context: Context, attrs: AttributeSet) : FrameLayout(context, attrs) {
    ...
    fun start(cameraSource: BarcodeReaderCameraSource) {
    ...
    companion object {
        private const val TAG = "BarcodeReaderCameraSourcePreview"
    }
}
