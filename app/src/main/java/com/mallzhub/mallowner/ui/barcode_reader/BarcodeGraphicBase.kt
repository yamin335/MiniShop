...
internal abstract class BarcodeGraphicBase(overlay: BarcodeReaderCameraGraphicOverlay) : BarcodeReaderCameraGraphicOverlay.Graphic(overlay) {
    ...
    val boxRect: RectF = BarcodeReaderPreferenceUtils.getBarcodeReticleBox(overlay)
