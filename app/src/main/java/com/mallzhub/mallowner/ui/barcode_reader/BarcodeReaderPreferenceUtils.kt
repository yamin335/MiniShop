...
import com.mallzhub.mallowner.ui.barcode_reader.camera.BarcodeReaderCameraSizePair

/** Utility class to retrieve shared preferences.  */
object BarcodeReaderPreferenceUtils {
...
//    }
    ...
    fun getProgressToMeetBarcodeSizeRequirement(
        overlay: BarcodeReaderCameraGraphicOverlay,
        barcode: Barcode
    ): Float {
    ...
    fun getBarcodeReticleBox(overlay: BarcodeReaderCameraGraphicOverlay): RectF {
        val context = overlay.context
    ...
    fun getUserSpecifiedPreviewSize(context: Context): BarcodeReaderCameraSizePair? {
        return try {
