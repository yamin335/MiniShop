...
internal class BarcodeConfirmingGraphic(overlay: BarcodeReaderCameraGraphicOverlay, private val barcode: Barcode) :
    ...
    override fun draw(canvas: Canvas) {
        ...
        val sizeProgress = BarcodeReaderPreferenceUtils.getProgressToMeetBarcodeSizeRequirement(overlay, barcode)
        val path = Path()
