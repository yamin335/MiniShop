...
import com.mallzhub.mallowner.ViewModelFactory
import com.mallzhub.mallowner.ar_location.ARLocationViewModel
import com.mallzhub.mallowner.nid_scan.NIDScanCameraXViewModel
import com.mallzhub.mallowner.ui.LoginActivityViewModel
import com.mallzhub.mallowner.ui.MainActivityViewModel
import com.mallzhub.mallowner.ui.add_payment_methods.AddBankViewModel
import com.mallzhub.mallowner.ui.add_payment_methods.AddCardViewModel
import com.mallzhub.mallowner.ui.add_payment_methods.AddPaymentMethodsViewModel
import com.mallzhub.mallowner.ui.add_product.AddProductViewModel
import com.mallzhub.mallowner.ui.cart.CartViewModel
import com.mallzhub.mallowner.ui.chapter_list.ChapterListViewModel
import com.mallzhub.mallowner.ui.exams.ExamsViewModel
import com.mallzhub.mallowner.ui.gift_point.GiftPointHistoryDetailsViewModel
import com.mallzhub.mallowner.ui.gift_point.GiftPointHistoryViewModel
import com.mallzhub.mallowner.ui.home.*
import com.mallzhub.mallowner.ui.how_works.HowWorksViewModel
...
import com.mallzhub.mallowner.ui.order.OrderTrackHistoryViewModel
import com.mallzhub.mallowner.ui.order.OrderViewModel
import com.mallzhub.mallowner.ui.otp_signin.OtpSignInViewModel
import com.mallzhub.mallowner.ui.pin_number.PinNumberViewModel
import com.mallzhub.mallowner.ui.pre_on_boarding.PreOnBoardingViewModel
import com.mallzhub.mallowner.ui.profiles.ProfilesViewModel
import com.mallzhub.mallowner.ui.registration.RegistrationViewModel
...
import com.mallzhub.mallowner.ui.terms_and_conditions.TermsViewModel
import com.mallzhub.mallowner.ui.topup.TopUpAmountViewModel
import com.mallzhub.mallowner.ui.topup.TopUpBankCardViewModel
import com.mallzhub.mallowner.ui.topup.TopUpMobileViewModel
import com.mallzhub.mallowner.ui.topup.TopUpPinViewModel
import com.mallzhub.mallowner.ui.tou.TouViewModel
import com.mallzhub.mallowner.ui.transactions.TransactionDetailsViewModel
import com.mallzhub.mallowner.ui.transactions.TransactionsViewModel
import com.mallzhub.mallowner.ui.video_play.LoadWebViewViewModel
import com.mallzhub.mallowner.ui.video_play.VideoPlayViewModel
import com.mallzhub.mallowner.ui.wallet.WalletViewModel
import dagger.Binds
