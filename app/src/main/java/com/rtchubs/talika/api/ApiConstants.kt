package com.rtchubs.talika.api

import com.rtchubs.talika.api.Api.API_REPO
import com.rtchubs.talika.api.Api.API_VERSION
import com.rtchubs.talika.api.Api.DIRECTORY_ACCOUNT
import com.rtchubs.talika.api.Api.DIRECTORY_BANK
import com.rtchubs.talika.api.Api.DIRECTORY_BANK_INFO
import com.rtchubs.talika.api.Api.DIRECTORY_CARD
import com.rtchubs.talika.api.Api.DIRECTORY_COMMON
import com.rtchubs.talika.api.Api.DIRECTORY_CONNECT
import com.rtchubs.talika.api.Api.DIRECTORY_PROFILE
...
object ApiEndPoint {
    ...
    const val GIFT_POINT_COLLECT = "/$API_REPO/set/com.rtchubs.talika/merchant/shopvisitreward"
    const val SHOP_WISE_GIFT_POINT = "/$API_REPO/get/com.rtchubs.talika/merchant/reward"
