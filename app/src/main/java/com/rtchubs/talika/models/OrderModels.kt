...
import com.rtchubs.talika.local_db.dbo.CartItem
...
data class OrderItem(val product_id: Int?, val description: String?, val unitType: String?,
                     ...
                     val amount: Int?, val product: Product?, val vatAndTax: Any?): Serializable
...
//                        val merchant: Merchant?, val category: ProductCategory?, val available_qty: Any?): Serializable
